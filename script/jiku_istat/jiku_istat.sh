...
mlr -I --jsonl --from "$folder"/tmp/istatcats.jsonl rename id,dataflowId then put '$enURL="https://esploradati.istat.it/RefMeta/template/GenericMetadataTemplate.html?nodeId=DW&metadataSetId=MDS_DIFF_REPORT&reportId=".$refId."&lang=en&BaseUrlMDA=https://esploradati.istat.it/METADATA_API"' then put '$itUrl="https://esploradati.istat.it/RefMeta/template/GenericMetadataTemplate.html?nodeId=DW&metadataSetId=MDS_DIFF_REPORT&reportId=".$refId."&lang=it&BaseUrlMDA=https://esploradati.istat.it/METADATA_API"' then put '$getMetadataURL="https://esploradati.istat.it/METADATA_API/api/getMetadata?metadataSetId=MDS_DIFF_REPORT&reportId=".$refId'

mlr --ijsonl --ojson cut -o -f dataflowId,refId,enName,itName,enURL,itUrl,getMetadataURL "$folder"/tmp/istatcats.jsonl >"$folder"/../../data/jiku_istat/istatcats.json
